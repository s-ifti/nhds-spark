/*
 * Copyright 2010-2013 Syed Ahmed
 *
...
public class NHDSFileInputFormatGeneric<K,V> extends FileInputFormat<K,V> {

    private static final Log LOG = LogFactory.getLog(NHDSFileInputFormatGeneric.class);
    ...
    public RecordReader createRecordReader(InputSplit split, TaskAttemptContext context)
        ...
        //}
        return new NHDSLineRecordReader();
    }
    /*
    @Override
    public RecordReader createRecordReader(final InputSplit split, final TaskAttemptContext context)
        ...
        BSONFileRecordReader reader = new NHDSFileRecordReader();
